...
public class TeavmJsPlugin implements TargetPlugin {
	...
	public void apply(ProjectConfig cfg, Path projectRoot, TemplateEngine engine) throws Exception {
		...
		String buildKts = engine.renderResource("teavm-js/build.gradle.kts.tpl", filters);
		...
		mainSrc.append("                    TargetType.JavaScript);\n");
