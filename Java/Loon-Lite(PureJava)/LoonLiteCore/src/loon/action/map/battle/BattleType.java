...
public class BattleType {
	...
	public static enum ObjectState {
		IDLE, MOVING, ATTACKING, DEFENSEING, CASTING, CASTING_SKILL, DEAD, FLEEING, PANICKED, FAKE_RETREAT, CONFUSED,
		STUNNED, FROZEN, BURNING, POISONED, SILENCED, FATIGUED, RESTING, HIDING, DEFENDING, WAITING, PATROLLING,
		AUTO_ATTACK, USING_ITEM, GARRISONED, BLOCKED, SKILL, PREPARE_ATTACK, PREPARE_SKILL, LEFT, RIGHT, UP, DOWN
	}
