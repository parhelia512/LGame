...
public final class Matrix3 implements Serializable, XY {
	...
	public final static Matrix3 setToCombineTransformRad(float cx, float cy, float scaleX, float scaleY, float radians) {
